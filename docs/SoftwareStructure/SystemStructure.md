...
![Software Structure Diagram]([url](https://github.com/detomo-inc/laravel-system-dev-convention/blob/main/docs/SystemStructure/architecture_common.png) "Software Structure Diagram")
